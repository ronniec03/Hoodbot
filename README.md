...
# Or download and extract the files to C:\Users\Justin\Documents\SpecialLady
```
...
```
SpecialLady/
├── enhanced_companion.py          # Main application
...
├── launch_enhanced.bat            # Application launcher
...
- Console output when running `python enhanced_companion.py`
